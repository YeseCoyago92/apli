            ...
            <section class="full-box page-content">
                ...
                <form action="../controller/controllerAdmin.php" class="form-neon" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="NOMBRE_ALIMENTOPREPARADO" id="item_nombre" required="true">
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label for="item_detalle" class="bmd-label-floating">Descripción: </label>
                                        <input type="text" class="form-control" name="DESCRIPCION_ALIMENTOPREPARADO" id="item_stock" required="true">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="imagen" name="IMAGEN_ALIMENTOPREPARADO" size="30" type="file" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <p class="text-center" style="margin-top: 40px;">
                        ...
                        <button type="button" class="btn btn-raised btn-warning btn-sm" onclick="return ConfirmarCancelar()"><i class="fas fa-close"></i> &nbsp; CANCELAR</button>
                        &nbsp; &nbsp;
