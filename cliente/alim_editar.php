        ...
        <main class="full-box main-container">
            ...
            <section class="full-box page-content">
                ...
                <div class="full-box page-header">
                    <h3 class="text-left">
                        <i class="fas fa-sync-alt fa-fw"></i> &nbsp; EDITAR OFERTA
                    </h3>
                </div>
                <div class="container-fluid">
                    <ul class="full-box list-unstyled page-nav-tabs">
                        <li>
                            <a href="#"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR NUEVA OFERTA</a>
                        </li>
                        <li>
                            <a href="alim_misofertas.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE DE MIS OFERTAS</a>
                        </li>
                    </ul>
                </div>
                ...
                <form action="../controller/controllerAdmin.php" class="form-neon" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="imagen" type="file" class="form-control" name="IMAGEN_ALIMENTOPREPARADO" value="<?php echo $alimento->getNombre_img(); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p class="text-center" style="margin-top: 40px;">
                        <button type="submit" class="btn btn-raised btn-secondary btn-sm" onclick="return ConfirmarCancelar()"><i class="fas fa-chevron-down"></i> &nbsp; CANCELAR</button>
                        &nbsp; &nbsp;
